...
// 基本型別 & 建構函數
let isByNewBoolean: Boolean = new Boolean(0);
...
// string
let isString: string = "txt";
console.log(isString); // txt
// 基本型別 & 建構函數
let isByNewString: String = new String("建構函數");
console.log(isByNewString); // [String: '建構函數']
//直接呼叫 String 物件返回 字串
let isBystring: string = String("呼叫String物件並返回字串");
...
// myStringNumber = true; // 'boolean' is not assignable to type 'string | number'.